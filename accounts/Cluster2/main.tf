...
module "confluent_kafka_topics" {
  ...
  kafka_api_key         = data.terraform_remote_state.confluent_api_key.outputs.confluent_api_key2_id
  kafka_api_secret      = data.terraform_remote_state.confluent_api_key.outputs.confluent_api_key2_secret
